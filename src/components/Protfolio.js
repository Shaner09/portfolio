...
function Portfolio() {
  return (
    <div className="Portfolio invis" style={{marginBottom:"0px"}}>
      ...
      <PortfolioPiece images={["/PortfolioPiece1.png"]} title="Kenzie Challenges" description="Kenzie Challenges is a website I made to house some of the last assignments that I completed with kenzie. My favorite challenge was tic-tac-toe, where I created a computer player that people have a hard time beating, but there is one sequence that you can use to win! can you find it?" link="https://kenziechallenges.herokuapp.com/"/>
    </div>
  );
}
